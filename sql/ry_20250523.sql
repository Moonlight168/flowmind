...
-- 初始化-菜单信息表数据
-- ----------------------------
-- 一级菜单（顺序：个人网站=1, 系统管理=2, 系统监控=3, 系统工具=4, 流程管理=5）
-- 注意：首页和工作台由前端路由固定，不需要数据库配置
insert into sys_menu values('3', '个人网站', '0', '1', 'http://codebyggbond.dpdns.org', null, '', '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', sysdate(), '', null, '个人网站外链');
insert into sys_menu values('4', '系统管理', '0', '2', 'system', null, '', '', 1, 0, 'M', '0', '0', '', 'system', 'admin', sysdate(), '', null, '系统管理目录');
insert into sys_menu values('5', '系统监控', '0', '3', 'monitor', null, '', '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', sysdate(), '', null, '系统监控目录');
insert into sys_menu values('6', '系统工具', '0', '4', 'tool', null, '', '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values('7', '流程管理', '0', '5', 'process', null, '', '', 1, 0, 'M', '0', '0', '', 'skill', 'admin', sysdate(), '', null, '流程管理目录');
-- 二级菜单（parent_id 修正：系统管理=4, 系统监控=5, 系统工具=6）
insert into sys_menu values('100',  '用户管理',       '4',   '1', 'user',       'system/user/index',                 '', '', 1, 0, 'C', '0', '0', 'system:user:list',        'user',          'admin', sysdate(), '', null, '用户管理菜单');
...
insert into sys_menu values('103',  '部门管理',       '4',   '4', 'dept',       'system/dept/index',                 '', '', 1, 0, 'C', '0', '0', 'system:dept:list',        'tree',          'admin', sysdate(), '', null, '部门管理菜单');
insert into sys_menu values('104',  '岗位管理',       '4',   '5', 'post',       'system/post/index',                 '', '', 1, 0, 'C', '0', '0', 'system:post:list',        'post',          'admin', sysdate(), '', null, '岗位管理菜单');
insert into sys_menu values('105',  '字典管理',       '4',   '6', 'dict',       'system/dict/index',                 '', '', 1, 0, 'C', '0', '0', 'system:dict:list',        'dict',          'admin', sysdate(), '', null, '字典管理菜单');
insert into sys_menu values('106',  '参数设置',       '4',   '7', 'config',     'system/config/index',               '', '', 1, 0, 'C', '0', '0', 'system:config:list',      'edit',          'admin', sysdate(), '', null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告',       '4',   '8', 'notice',     'system/notice/index',               '', '', 1, 0, 'C', '0', '0', 'system:notice:list',      'message',       'admin', sysdate(), '', null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理',       '4',   '9', 'log',        '',                                  '', '', 1, 0, 'M', '0', '0', '',                        'log',           'admin', sysdate(), '', null, '日志管理菜单');
insert into sys_menu values('109',  '在线用户',       '5',   '1', 'online',     'monitor/online/index',              '', '', 1, 0, 'C', '0', '0', 'monitor:online:list',     'online',        'admin', sysdate(), '', null, '在线用户菜单');
insert into sys_menu values('110',  '定时任务',       '5',   '2', 'job',        'monitor/job/index',                 '', '', 1, 0, 'C', '0', '0', 'monitor:job:list',        'job',           'admin', sysdate(), '', null, '定时任务菜单');
insert into sys_menu values('111',  'Sentinel控制台', '5',   '3', 'http://localhost:8718',        '',                '', '', 0, 0, 'C', '0', '0', 'monitor:sentinel:list',   'sentinel',      'admin', sysdate(), '', null, '流量控制菜单');
insert into sys_menu values('112',  'Nacos控制台',    '5',   '4', 'http://localhost:19090/nacos',  '',                '', '', 0, 0, 'C', '0', '0', 'monitor:nacos:list',      'nacos',         'admin', sysdate(), '', null, '服务治理菜单');
insert into sys_menu values('113',  'Admin控制台',    '5',   '5', 'http://localhost:8090/login',  '',                '', '', 0, 0, 'C', '0', '0', 'monitor:server:list',     'server',        'admin', sysdate(), '', null, '服务监控菜单');
insert into sys_menu values('114',  '表单构建',       '6',   '1', 'build',      'tool/build/index',                  '', '', 1, 0, 'C', '0', '0', 'tool:build:list',         'build',         'admin', sysdate(), '', null, '表单构建菜单');
insert into sys_menu values('115',  '代码生成',       '6',   '2', 'gen',        'tool/gen/index',                    '', '', 1, 0, 'C', '0', '0', 'tool:gen:list',           'code',          'admin', sysdate(), '', null, '代码生成菜单');
insert into sys_menu values('116',  '系统接口',       '6',   '3', 'http://localhost:8080/swagger-ui/index.html', '', '', '', 0, 0, 'C', '0', '0', 'tool:swagger:list',       'swagger',       'admin', sysdate(), '', null, '系统接口菜单');
-- 流程管理子菜单
insert into sys_menu values('2351', '流程分类', '7', '1', 'category', 'workflow/category/index', '', '', 1, 0, 'C', '0', '0', 'workflow:category:list', 'nested', 'admin', sysdate(), '', null, '流程分类菜单');
insert into sys_menu values('2352', '表单配置', '7', '2', 'form', 'workflow/form/index', '', '', 1, 0, 'C', '0', '0', 'workflow:form:list', 'form', 'admin', sysdate(), '', null, '表单配置菜单');
insert into sys_menu values('2353', '流程模型', '7', '3', 'model', 'workflow/model/index', '', '', 1, 0, 'C', '0', '0', 'workflow:model:list', 'component', 'admin', sysdate(), '', null, '流程模型菜单');
insert into sys_menu values('2354', '部署管理', '7', '4', 'deploy', 'workflow/deploy/index', '', '', 1, 0, 'C', '0', '0', 'workflow:deploy:list', 'example', 'admin', sysdate(), '', null, '部署管理菜单');
-- 流程分类子菜单
...
-- ----------------------------
-- 初始化-角色和菜单关联表数据
-- 注意：menu_id 已更新为新菜单结构
-- ----------------------------
insert into sys_role_menu values ('2', '4');   -- 系统管理
insert into sys_role_menu values ('2', '5');   -- 系统监控
insert into sys_role_menu values ('2', '6');   -- 系统工具
